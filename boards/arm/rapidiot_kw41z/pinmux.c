 ...
 * Copyright (c) 2019, Marcio Montenegro 
 *
...
static int rapidiot_kw41z_pinmux_init(struct device *dev)
{
	ARG_UNUSED(dev);
...
SYS_INIT(rapidiot_kw41z_pinmux_init, PRE_KERNEL_1, CONFIG_PINMUX_INIT_PRIORITY);
